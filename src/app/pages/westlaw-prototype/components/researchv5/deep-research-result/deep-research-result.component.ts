...
import { PlanTasksComponentv5 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv5 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv5;
