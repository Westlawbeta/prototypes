...
import { PlanTasksComponentv10 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv10 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv10;
  @ViewChild('popover') popoverRef!: ElementRef<HTMLDivElement>;
  @ViewChild('scrollContainer') private scrollContainer!: ElementRef;
  @ViewChild('scrollContainerFollowups') private scrollContainerFollowups!: ElementRef;
  ...
  followupResponse(){
    if(this.numberOfFollowUps === 1){
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          const followupsTab = document.querySelector('[aria-label="Follow-ups"]');
          (followupsTab as HTMLElement)?.click();
        }, 200);
        
        //this.scrollToBottomFollowups(); // Scroll to the bottom of the container
      }, 3000);
  ...
  scrollToBottomFollowups(): void {
    setTimeout(() => {
      this.scrollContainerFollowups.nativeElement.scrollTop = this.scrollContainerFollowups.nativeElement.scrollHeight;
    }, 500);
  }
}
