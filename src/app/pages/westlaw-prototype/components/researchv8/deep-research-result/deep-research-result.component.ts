...
import { PlanTasksComponentv8 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv8 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv8;
