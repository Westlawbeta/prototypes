...
import { PlanTasksComponentv9 } from './plan-tasks/plan-tasks.component';
...
export class DeepResearchResultComponentv9 {
  ...
  @ViewChild('planTasks') planTasksComponent!: PlanTasksComponentv9;
